...
function changeLanguageEs(){
    cvLanguages.innerHTML = `<i class="fas fa-language"></i><p><span class="highlighted">Español</span class="highlighted"> <br> Nativo</p><i class="fas fa-language"></i><p><span class="highlighted">Inglés</span class="highlighted"> <br> Fluido</p><i class="fas fa-language"></i><p><span class="highlighted">Portugués</span class="highlighted"> <br> Intermedio</p>`;
